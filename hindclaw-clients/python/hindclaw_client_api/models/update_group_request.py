...
class UpdateGroupRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["display_name", "recall", "retain", "retain_roles", "retain_tags", "retain_every_n_turns", "recall_budget", "recall_max_tokens", "recall_tag_groups", "llm_model", "llm_provider", "exclude_providers", "retain_strategy"]
