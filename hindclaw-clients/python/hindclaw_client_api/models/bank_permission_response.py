...
class BankPermissionResponse(BaseModel):
    """
    Bank-level permission entry with scope identifiers.  Returned by GET /banks/:bank/permissions endpoints.
    """ # noqa: E501
    bank_id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["bank_id", "scope_type", "scope_id", "recall", "retain", "retain_roles", "retain_tags", "retain_every_n_turns", "recall_budget", "recall_max_tokens", "recall_tag_groups", "llm_model", "llm_provider", "exclude_providers", "retain_strategy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankPermissionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankPermissionResponse from a dict"""
        if obj is None:
            return None
