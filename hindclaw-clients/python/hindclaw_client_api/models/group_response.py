...
class GroupResponse(BaseModel):
    """
    Group resource with all permission fields.  Returned by GET /groups/:id and POST /groups. Permission fields are nullable — None means \"not set (inherit from global).\"
    """ # noqa: E501
    id: StrictStr
